...
reader = XMLPartitionedUnstructuredGridReader(FileName=['/home/faiz89/Data_On_Console/10lines.pvtu'])
...
WriteAnimation('/home/faiz89/Data_On_Console/Animation2/frame.png', Magnification=1, FrameRate=15.0, Compression=True)
