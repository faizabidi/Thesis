...
for i in {0..14..2};do
    j=$((($i/2)+1))
    DISPLAY=:0.$i vncviewer -fullscreen=$7 -passwd=passwd -encoding $ENCODING -jpeg=$JPEG -quality $QUALITY -subsampling $SUBSAMPLING -compresslevel $COMPRESS_LEVEL $SERVER:$j &
done
